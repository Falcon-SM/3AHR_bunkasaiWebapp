...
const mondai = [
    ...
    "？に入るイラストが表す言葉は？",
    "嘘をついているB組生徒の名を出席番号順に読め。\n下の5人は全員同じB組である。なお、1人は正直者であることはわかっているようだ。",
...
export default function Home() {
    ...
    const hints = [["指示に従って迷路を辿ってみましょう", "最初は上に向かいます", "家康だよ！"], ["この人が登場する有名な戦国ゲームがあるよ！", "〇〇の野望", "織田信長っていう人だよ！"], ["a", "b", "c"], ["a", "b", "d"], ["廻天", "結", "Reboot"], ["z", "b", "c"]]
    // Base64暗号テキスト（第1問用）
